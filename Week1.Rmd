...
The objective of this capstone project is to bring together the skils learned across the entire 9 segment course. This project is created from ground-up, right from sourccing data, cleaning, formatting and using them to train models and deploy them as a application.
