...
rData_path <- "Users/harsha/Projects/DataScience_Coursera/DS_Capstone/NextWordPrediction/RData"
...
getCSampledData <- function() {
  ...
  # Lets take 5% of the data and merge them
  sample_size <- 0.05
